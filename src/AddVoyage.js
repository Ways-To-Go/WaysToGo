    ...
    return (
      <div class="etapevoyage">
        ...
        <input
          ...
          id="nometape"
          name="nometape"
          placeholder="ex. Promenade dans Paris"
        ></input>
...
class CreationVoyageAjoutEtapes extends React.Component {
  ...
  addEtapeVoyage() {
    ReactDOM.render(
      <UneEtape />,
      this.setTextInputRef.current.appendChild(document.createElement("div"))
    );
  }
      ...
      <div id="information">
        <EnteteVoyage
          param={{
            ...
            ecolo: this.state.ecolo,
            stages: [],
            author: { firstName: "Nicolas", lastName: "Dupond" },
          }}
        />

        <div ref={this.setTextInputRef}></div>
        <button type="button" onClick={this.addEtapeVoyage.bind(this)}>
          Ajouter une étape
        </button>
      </div>
    );
    ...
    return (
      <div class="formulaire">
        ...
        <div class="partie">
          ...
          <div class="partiedetails">
            ...
            <input
              ...
              id="fname"
              name="firstname"
              placeholder="ex. Un grand tour de la France"
            ></input>
            ...
            <textarea
              ...
              id="lname"
              name="lastname"
              placeholder="ex. Un voyage bucolique à travers la campagne francaise : vieux vestiges et spécialités locales"
            ></textarea>
          </div>
        </div>
        ...
        <button
          type="button"
          class="boutonsend"
          onClick={this.state.addMyVoyage}
        >
          Ajouter le voyage
        </button>
      </div>
...
export default class AddVoyage extends Component {
  ...
  addMyVoyage() {
    if (
      this.description.current.validity.valid &&
      this.name.current.validity.valid &&
      this.startdate.current.validity.valid &&
      this.enddate.current.validity.valid
    )
      this.setState({
      ...
      <div>
        ...
        {this.state.startNewVoyage ? (
          <CreationVoyage
            ...
            vegan={this.vegan}
            ecolo={this.ecolo}
            addMyVoyage={this.addMyVoyage}
            description={this.description}
            startdate={this.startdate}
            enddate={this.enddate}
          />
        ) : (
          <CreationVoyageAjoutEtapes
            name={this.name.current}
            vegan={this.vegan.current.checked}
            ecolo={this.ecolo.current.checked}
            description={this.description.current}
            startdate={this.startdate.current}
            enddate={this.enddate.current}
          />
        )}
      </div>
    );

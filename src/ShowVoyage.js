					...
					toRender:
						<div id="information">
							<div id="head">
								...
								<p>{param.vegan ? "Ce voyage est vegan" : "Ce voyage est signal√© comme non-vegan"}</p>
								<p>{param.ecological ? "Ce voyage est ecologique" : "Ce voyage est signal√© comme non-ecologique"}</p>
								...
								{param.stages.map((etape) => (
									<div>
										<div class="etape">
											...
											<p class="villedate_etape">{etape.city + " ï " + new Date(etape.arrival)}</p>
										...
										{etape.departureTransport ?
											<div class="transition_etape">
												<p class="transitionTexte">ï Moyen de transport : {etape.departureTransport.type}</p>
											</div>
											: ""}
									</div>
								))}
